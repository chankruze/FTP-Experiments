package in.geekofia.ftpfm.managers;
...
import in.geekofia.ftpfm.interfaces.UiThreadCallback;
import in.geekofia.ftpfm.utils.Util;


public class TransferThreadPoolManager {
    private static TransferThreadPoolManager sInstance = null;
    ...
    static {
        ...
        sInstance = new TransferThreadPoolManager();
    }

    private TransferThreadPoolManager() {
    ...
    public static TransferThreadPoolManager getsInstance() {
        return sInstance;
    }
